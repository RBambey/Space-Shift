// Goo — Flight physics
// Adapted from Remnant Planet by RBambey
//
// Camera starts at the tunnel center at z=0.
// path(0) = (0, TunnelAmpB) = (0, 2.4324) — the goo tunnel center.
// fly_speed default 4.5 matches the original shader's CameraSpeed.

var cam = (function(opts) {
    opts = opts || {};

    var camX = opts.startX != null ? opts.startX : 0.0;
    var camY = opts.startY != null ? opts.startY : 2.4324;
    ...
    function update(dt, controls, callbacks) {
        ...
        // Forward movement — free 3D flight through the tunnel
        camFwd = normalize3(camFwd);
