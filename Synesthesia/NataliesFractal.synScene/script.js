// Natalie's Fractal — Flight physics
// Adapted from Ocean Planet by RBambey
//
// Key differences from Ocean Planet:
//   - startY: 0.0 (no "ocean surface" to float above)
//   - altMin/altMax: ±100  (free 3D flight — no terrain floor/ceiling)
//   - fly_speed default is much smaller in scene.json (0.05 vs 12)
//     to allow precise navigation at fractal scales
...
var cam = (function(opts) {
    ...
    function update(dt, controls, callbacks) {
        ...
        // Altitude clamp: very wide — the fractal has no terrain floor/ceiling
...
})({ startX: 0.0, startY: 0.0, startZ: -2.0 });
...
function update(dt) {
    cam.update(dt,
        ...
        { recenterY: function()    { return 0.0; },
          altMin:    function()    { return -100.0; },
          altMax:    function()    { return  100.0; } }
    );
}
