// Cloud Ten Flying — 6-DOF flight physics (ported from Ocean Planet)
...
var cam = (function(opts) {
    ...
    function update(dt, controls, callbacks) {
        ...
        // Forward movement — no altitude constraint, free flight through clouds
        camFwd = normalize3(camFwd);
...
function update(dt) {
    cam.update(dt,
        ...
        { recenterY: function() { return  0.0; },
          altMin:    function() { return -12.0; },  // just below cloud layer — deeper breaks rendering
          altMax:    function() { return  20.0; } } // above this clouds thin out too much
    );
}
